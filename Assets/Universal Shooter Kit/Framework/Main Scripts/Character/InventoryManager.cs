...
namespace GercStudio.USK.Scripts
{
    ...
    public class InventoryManager : MonoBehaviour
    {
        ...
        //     for (var i = 0; i < 8; i++)
        //     {
        //         foreach (var slot in slots[i].weaponSlotInGame.Where(slot => slot != null && !slot.fistAttack && slot.weapon))
        //         {
        ...
        //     for (var i = 0; i < 8; i++)
        //     {
        //         for (var j = 0; j < slots[i].weaponSlotInGame.Count; j++)
        //         {
        //             if (slots[i].weaponSlotInGame[j].weapon.GetInstanceID() == weapon.GetInstanceID())
        //             {
        //                 foreach (var kit in slots[i].weaponSlotInGame[j].WeaponAmmoKits)
        //                 {
        //                     ReserveAmmo.Add(kit);
        //                 }
        //
        //                 slot = i;
        //
        //                 Destroy(slots[i].weaponSlotInGame[j].weapon);
        //                 
        //                 slots[i].weaponSlotInGame.RemoveAt(j);
        //                 
        //                 FindWeapon(true, true);
        //                 
        //                 break;
        ...
        // }
        //
        // private void AddNewWeapon(GameObject weapon, int inventorySlot)
        // {
        //     WeaponsHelper.InstantiateWeapon(weapon, inventorySlot, this, Controller);
        //     FindWeapon(true, true);
        // }

        // private void SwitchWeaponInSlot()
        // {
        //     if (slots[currentSlot].currentWeaponInSlot == slots[currentSlot].weaponSlotInGame.Count - 1)
        //         slots[currentSlot].currentWeaponInSlot = -1;
        //     
        //     FindWeapon(true, true);
        // }
        ...
        //     {
        //         Controller.CharacterSync.UpdateWeaponsManually("clear");
        //     }
        // }
        //
        // public void AddNewWeapon(GameObject weapon, int inventorySlot)
        // {
        //     WeaponsHelper.InstantiateWeapon(weapon, inventorySlot, this, Controller);
        ...
        //     if (!Controller.isMultiplayerCharacter)
        //     {
        //         Controller.CharacterSync.UpdateWeaponsManually("add");
        //     }
        // }
        //
        ...
        public void DropWeapon(bool getNewWeapon)
        {
            ...
            if (!curWeapon.weapon.GetComponent<PickupItem>())
            {
                var pickUpScript = curWeapon.weapon.AddComponent<PickupItem>();
                ...
                pickUpScript.inventorySlot = currentSlot + 1;
...
//            Controller.CameraController.rightPart.gameObject.SetActive(true);
        ...
        IEnumerator DropTimeOut(CharacterHelper.Weapon curWeapon)
        {
            ...
            curWeapon.weapon.GetComponent<PickupItem>().enabled = true;
            canDropWeapon = true;
