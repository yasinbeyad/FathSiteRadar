...
//             }
        ...
        void CheckButtons()
        {
            ...
            if (Controller.projectSettings.ButtonsActivityStatuses[19] && (InputHelper.WasKeyboardOrMouseButtonPressed(projectSettings.keyboardButtonsInUnityInputSystem[19]) ||
                ...
                //(Input.GetKeyDown(Controller._gamepadCodes[17]) || Input.GetKeyDown(Controller._keyboardCodes[19]) || Helper.CheckGamepadAxisButton(17, Controller._gamepadButtonsAxes, Controller.hasAxisButtonPressed, "GetKeyDown", Controller.projectSettings.AxisButtonValues[17])))
                ChangeAttack();
                ...
                else
                {
                        ...
                        || Attacks[currentAttack].AttackType == WeaponsHelper.TypeOfAttack.GrenadeLauncher || Attacks[currentAttack].AttackType == WeaponsHelper.TypeOfAttack.Grenade)
                    {
                        if (Controller.projectSettings.ButtonsActivityStatuses[3] && (!Controller.projectSettings.mobileDebug && (InputHelper.WasKeyboardOrMouseButtonPressed(Controller.projectSettings.keyboardButtonsInUnityInputSystem[3]) ||
                            ...
                            //  (!Controller.projectSettings.mobileDebug && (Helper.CheckGamepadAxisButton(3, Controller._gamepadButtonsAxes, Controller.hasAxisButtonPressed, "GetKeyDown", Controller.projectSettings.AxisButtonValues[3])
            ...
            else
            {
                ...
                // {
                    ...
                    {
                        var condition = hit.collider.transform.root.gameObject.GetComponent<AIController>() && hit.distance <= Attacks[currentAttack].attackDistance &&
                        ...
                        if (Controller.TypeOfCamera == CharacterHelper.CameraType.TopDown || Controller.TypeOfCamera == CharacterHelper.CameraType.ThirdPerson && Controller.emulateTDModeLikeTP)
                        {
                            condition = hit.collider.transform.root.gameObject.GetComponent<AIController>() && hit.distance <= Attacks[currentAttack].attackDistance &&
