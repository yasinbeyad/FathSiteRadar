...
namespace GercStudio.USK.Scripts
{
    ...
    public class PickupItem : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (blipTexture && uiManager && uiManager.CharacterUI.mapMask && !minimapImage.image)
            {
                            ...
                            if (ammoName == "")
                            {
                                if (!autoApply)
                                {
                                    weapon.WeaponAmmoKits.Add(new CharacterHelper.Kit
                                        {AddedValue = ammoAmount, Image = inventoryTexture, ammoType = ammoName, PickUpId = pickUpId});
                                    hasWeapon = true;
                                }
                                else
                                {
