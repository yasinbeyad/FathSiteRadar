...
namespace GercStudio.USK.Scripts
{
...
#endif
    {
        ...
        void Start()
        {
            ...
            {
                var _car = car.gameObject.GetComponent<InteractionWithUSKCharcaters>();
            ...
            foreach (var car in VehicleChanger.Instance.vehicles)
            {
                var _car = car.gameObject.AddComponent<InteractionWithUSKCharcaters>();
                allVehiclesInScene.Add(_car);
            }
        ...
        void GetInVehicle()
        {
            ...
            VehicleChanger.Instance.ChangeVehicle(targetVehicle.vehicleController);
            ...
            if (!inCar)
            {
                ...
                if (useRayCast)
                {
                    ...
                    if (!targetVehicle)
                    {
                        ...
                        if (!targetVehicle)
                        {
                            targetVehicle = hit.collider.transform.GetComponentInParent<InteractionWithUSKCharcaters>();
                        }
#endif
                        else
                        {
