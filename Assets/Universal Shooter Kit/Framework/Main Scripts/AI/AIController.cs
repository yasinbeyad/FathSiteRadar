                ...
                foreach (var player in allPlayersInScene)
                {
                    ...
                    else
                    {
                        ...
                        if (opponentsDetectionType == AIHelper.OpponentsDetectionType.Vision || opponentsDetectionType == AIHelper.OpponentsDetectionType.All)
                        {
                            ...
                            {
                                player.seePlayerHips = !grenadeEffect && AIHelper.CheckRaycast(player.controller.BodyObjects.Hips, bodyDirectionObject, peripheralHorizontalAngle, centralHorizontalAngle, heightToSee, distanceToSee, currentState == AIHelper.EnemyStates.Attack, ref player.seeDirectly, ref player.isObstacle, visionHits, ref player.inSight);
                                player.seePlayerHead = !grenadeEffect && AIHelper.CheckRaycast(player.controller.BodyObjects.Head, bodyDirectionObject, peripheralHorizontalAngle, centralHorizontalAngle, heightToSee, distanceToSee, currentState == AIHelper.EnemyStates.Attack, ref player.seeDirectly, ref player.isObstacle, visionHits, ref player.inSight);
                        ...
                        else if (currentState== AIHelper.EnemyStates.Attack && (opponentsDetectionType == AIHelper.OpponentsDetectionType.Hearing || opponentsDetectionType == AIHelper.OpponentsDetectionType.CloseRange))
                        {
                            if (distance < distanceToSee)
                            {
                                player.seePlayerHips = AIHelper.CheckRaycast(player.controller.BodyObjects.Hips, bodyDirectionObject, peripheralHorizontalAngle, centralHorizontalAngle, heightToSee, distanceToSee, currentState == AIHelper.EnemyStates.Attack, ref player.seeDirectly, ref player.isObstacle, visionHits, ref player.inSight);
