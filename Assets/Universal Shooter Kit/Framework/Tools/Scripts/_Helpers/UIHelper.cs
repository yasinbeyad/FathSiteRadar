...
//			public Text MatchTimer;
		...
		public static void ManageUIButtons(Controller controller, InventoryManager manager, UIManager uiManager, bool isMultiplayer)
		{
			...
			{
				activityConditions = mainConditions && controller.projectSettings.ButtonsActivityStatuses[3] && (manager.allWeaponsCount > 1 || manager.HasFistAttack) && (weaponController && !weaponController.Attacks[weaponController.currentAttack].autoAttack || !weaponController);
			...
			{
				activityConditions = mainConditions && controller.TypeOfCamera != CharacterHelper.CameraType.FirstPerson;
